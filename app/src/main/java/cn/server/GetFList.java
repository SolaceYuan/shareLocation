...
public class GetFList implements Runnable {
    ...
    private GetFlistRe inputStream;
    private HomeActivity homeActivity;

    public GetFList(HomeActivity homeActivity) {
    ...
    private void startSocket() {
        try {
            ...
            inputStream = new GetFlistRe(socket.getInputStream());
    ...
    public void run() {
        try {
            ...
            jsonObject.put("id", homeActivity.getPhoneNum());
            ...
            Looper.prepare();
            Toast.makeText(homeActivity,"服务器连接超时",Toast.LENGTH_SHORT);
            Looper.loop();
        }
